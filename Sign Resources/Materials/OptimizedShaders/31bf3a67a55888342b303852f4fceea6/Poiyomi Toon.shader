Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/31bf3a67a55888342b303852f4fceea6"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				#if defined(PROP_LOOKATMASK) || !defined(OPTIMIZER_ENABLED)
				lookAtMask = tex2Dlod(_LookAtMask, float4(poiUV(vertexUV(v, 0.0), float4(1,1,0,0)) + _Time.x * float4(0,0,0,0), 0, 0));
				#endif
				lookAtMask *= alpha;
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + 0.69);
				if (0.0 > 0)
				{
