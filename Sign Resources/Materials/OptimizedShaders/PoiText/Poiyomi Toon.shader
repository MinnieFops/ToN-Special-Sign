Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/1975288d27ca2ea4fbc57778eed496e3"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + (0.69 /*_AlphaMod*/));
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalRotation = (315.0 /*_DecalRotation*/);
				...
				Decal1.m_DecalTextureUV = (2.0 /*_DecalTexture1UV*/);
